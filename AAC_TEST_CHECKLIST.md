# Samy AAC Test Checklist

Use this checklist before publishing changes that touch vocabulary, layout, speech, or editing.
...
- The الأشخاص folder includes أخ, أخت, جد, جدة, صديق, معلم, طبيب.
- The طبي folder includes ألم, جائع, عطشان, الحمام, تعبان, مريض, دواء, طبيب, حرارة, طوارئ, ألم هنا, أحتاج مساعدة, بطني يؤلمني, رأسي يؤلمني, أشعر بالبرد, أشعر بالحر, أحتاج راحة, اتصل بالطبيب.
- The عبارات سريعة folder includes أين هو؟, أين أمي؟, أحتاج استراحة, لا أفهم, أعد ذلك, ساعدني, أنا بخير, أريد اللعب, أريد الأكل, أريد الشرب.
- Beginner shows fewer high-frequency words, Intermediate uses the 5x5 board, and Advanced reveals grammar, time, and phrase folders.
- High contrast, extra large buttons, auditory feedback, and touch delay controls are available in Customize.
- Vocabulary items keep this replaceable symbol structure: id, arabicLabel, englishKey, category, symbol, colorType, isCore, imageUrl.
